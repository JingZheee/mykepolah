              ...
              children: [
                Padding(
                  padding: EdgeInsets.fromLTRB(
                      ScreenSize.horizontal! * 5, ScreenSize.vertical! * 2, 0, 0),
                  child: Text(
                    "Progress update",
                    style: TextStyle(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    "Check Report",
                    style: TextStyle(
                        fontSize: ScreenSize.horizontal! * 4.5, fontWeight: FontWeight.w800),
                  ),
                ),
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        Container(
          decoration:
              BoxDecoration(color: Color(0xffABEDD8), borderRadius: BorderRadius.circular(15)),
        ...
        Text(
          text,
          style:
              TextStyle(color: Color(0xff47466D), fontSize: fontSize, fontWeight: FontWeight.w700),
        ),
      ],
    );
  }
